...
<head>
    ...
    // Join Open js Function
    function OpenJoin(){
        let a = window.open("./join/","_Self");
    }
    // search
    function myFunction(){
...
/* --------------------------------------------mobile css ---------------------------------------------------------- */
        ...
        #myUL table h4:hover:not(.header) {
...
<body>
    ...
    <div id="page-container">
        ...
        <!-- mobile Page Heading -->
        <div id="page-heading"><h1>Blogs</h1></div>
        <!-- mobile search box -->
        <div id="search-box-container">
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Blogs" title="Type in a name" autocomplete="off">
        </div>
        <!-- Content -->
        <div id="content">
        <?php
        ...
        ?>
        <a href="<?php echo $data['blogURL']; ?>">
            <table>
                <tr>
                    <td>
                        <span><img src="<?php echo $data['imageURL']; ?>" id="thumbnail" alt="<?php echo $data['imageDescription']; ?>"></span>
                    </td>
                    <td id="blog-details-information">
                        <h4 id="blog-heading"><?php echo $data['heading']; ?></h4>
                        <p id="blog-category-container"><span id="blog-category"><?php echo $data['mainCategory']; ?></span><span id="blog-category"><?php echo $data['subCategory']; ?></span></p>
                    </td>
                </tr>
            </table>
        </a>
    ...
    <!-- Side navigation Drawer Elements -->
