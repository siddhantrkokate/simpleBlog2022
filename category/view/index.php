...
<body>
    ...
    <div id="page-container">
        ...
        <!-- Page Heading -->
        <div id="page-heading"><h1><?php $category=$_GET['category']; echo $category; ?></h1></div>
        <!-- search box container -->
        ...
        <?php
            $fet = $_GET['category'];
            $select = "SELECT * FROM blog WHERE mainCategory LIKE '%$fet%' OR subCategory LIKE '%$fet%' ORDER BY id DESC";
            $query = mysqli_query($connection, $select);
            while($row = mysqli_fetch_array($query)){
        ?>
        <a href="<?php echo $row['blogURL']; ?>">
            <table>
                <tr>
                    <td>
                        <span><img src="<?php echo $row['imageURL']; ?>" alt="<?php echo $row['imageDescription']; ?>" id="thumbnail"></span>
                    </td>
                    <td id="info">
                        <h4 id="heading"><?php echo $row['heading']; ?></h4>
                        <p id="category-container"><span id="category"><?php echo $row['mainCategory']; ?></span><span id="category"><?php echo $row['subCategory']; ?></span></p>
                    </td>
                </tr>
            </table>
        </a>
